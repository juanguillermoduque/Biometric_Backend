...
class FichasController {
    list(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const fichas = yield database_1.default.query('SELECT * FROM fichas');
            res.json(fichas);
        });
    }
    create(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            yield database_1.default.query('INSERT INTO fichas SET ?', [req.body]);
            res.json({
    ...
    update(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const { id } = req.params;
            yield database_1.default.query('UPDATE fichas SET ? WHERE idfichas = ?', [req.body, id]);
        });
    }
    getOne(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
